...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { myclk }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { start_con }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { pause }]; #IO_L10N_T1_D15_14 Sch=btnr
